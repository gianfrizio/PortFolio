...
export const metadata: Metadata = {
  ...
  description: "Portfolio professionale di Vittorio Ciampi - Junior Software Developer specializzato in sviluppo mobile cross-platform, Full Stack, game development e integrazione AI. Competenze in Flutter, Dart, React Native, Expo, Node, MongoDB, Express, React, Next.js, C/C++, SDL2.",
  keywords: ["Full Stack Developer", "Mobile Developer", "Flutter Developer", "Game Developer", "AI Integration", "Node", "MongoDB", "Express", "Flutter", "Dart", "React Native", "Expo", "React", "Next.js", "C++", "SDL2", "Vittorio Ciampi"],
