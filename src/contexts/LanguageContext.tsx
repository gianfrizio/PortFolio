...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    'experience.items.mobile.title': 'React Native/Expo Developer',
    'experience.items.mobile.company': 'Aivi',
    'experience.items.mobile.location': 'Remoto',
    'experience.items.mobile.period': 'Novembre 2025 - Presente',
    'experience.items.mobile.description': 'Sviluppo di applicazioni mobile cross-platform utilizzando React Native Expo, con focus su user experience e integrazione IA.',
    'experience.items.mobile.achievements.0': 'Sviluppato app mobile con React Native Expo e TypeScript',
    'experience.items.mobile.achievements.1': 'Gestione delle build e del deploy tramite Expo (EAS)',
    'experience.items.mobile.achievements.2': 'Gestione stato avanzata con Context API e AsyncStorage',
    'experience.items.mobile.achievements.3': 'Creato UI/UX responsive e ottimizzata per iOS e Android',
    'experience.items.flutter.title': 'Flutter Developer',
    'experience.items.flutter.company': 'Ordinoo',
    'experience.items.flutter.location': 'Remoto',
    'experience.items.flutter.period': 'Giugno 2026 - Agosto 2026',
    'experience.items.flutter.description': 'Sviluppo di applicazioni mobile cross-platform (iOS/Android) con Flutter, con focus su implementazione UI/UX, gestione dello stato e integrazione di API REST.',
    'experience.items.flutter.achievements.0': 'Sviluppato applicazioni mobile cross-platform (iOS/Android) con Flutter e Dart',
    'experience.items.flutter.achievements.1': 'Implementato interfacce UI/UX responsive con widget personalizzati e Material Design',
    'experience.items.flutter.achievements.2': 'Gestito lo stato dell\'applicazione con pattern dedicati e navigazione strutturata',
    'experience.items.flutter.achievements.3': 'Integrato API REST con gestione asincrona di dati, caching ed errori',
  ...
  en: {
    ...
    'experience.items.frontend.period': 'September 2025 - Completed',
    ...
    'experience.items.mobile.title': 'React Native/Expo Developer',
    'experience.items.mobile.company': 'Aivi',
    'experience.items.mobile.location': 'Remote',
    'experience.items.mobile.period': 'November 2025 - Present',
    'experience.items.mobile.description': 'Cross-platform mobile application development using React Native Expo, focusing on user experience and AI integration.',
    'experience.items.mobile.achievements.0': 'Developed mobile apps with React Native Expo and TypeScript',
    'experience.items.mobile.achievements.1': 'Build and deployment management using Expo (EAS)',
    'experience.items.mobile.achievements.2': 'Advanced state management with Context API and AsyncStorage',
    'experience.items.mobile.achievements.3': 'Created responsive UI/UX optimized for iOS and Android',
    'experience.items.flutter.title': 'Flutter Developer',
    'experience.items.flutter.company': 'Ordinoo',
    'experience.items.flutter.location': 'Remote',
    'experience.items.flutter.period': 'June 2026 - August 2026',
    'experience.items.flutter.description': 'Development of cross-platform mobile applications (iOS/Android) using Flutter, focusing on UI/UX implementation, state management and REST API integration.',
    'experience.items.flutter.achievements.0': 'Developed cross-platform mobile applications (iOS/Android) with Flutter and Dart',
    'experience.items.flutter.achievements.1': 'Implemented responsive UI/UX with custom widgets and Material Design',
    'experience.items.flutter.achievements.2': 'Managed application state with dedicated patterns and structured navigation',
    'experience.items.flutter.achievements.3': 'Integrated REST APIs with asynchronous data handling, caching and error management',
