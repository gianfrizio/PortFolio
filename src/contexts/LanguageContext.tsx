...
const translations: Record<Language, Record<string, string>> = {
  it: {
    ...
    'about.highlights.cleanCode.description': 'Codice leggibile e maintainabile',
    ...
    'skills.items.react': 'React & Hooks',
    ...
    'skills.items.microservices': 'Microservizi',
    ...
    'experience.items.fullstack.title': 'Full Stack Developer',
    'experience.items.fullstack.company': 'Progetti Personali & Portfolio',
    'experience.items.fullstack.location': 'Remote',
    'experience.items.fullstack.period': 'Presente',
    'experience.items.fullstack.description': 'Sviluppo di applicazioni web moderne utilizzando le tecnologie più recenti, con focus su architetture scalabili e user experience ottimale.',
    'experience.items.fullstack.achievements.0': 'Sviluppato 7+ progetti full-stack completi con React, Next.js, Spring Boot e Flutter',
    'experience.items.fullstack.achievements.1': 'Implementato architetture RESTful e microservizi con Java Spring Boot',
    'experience.items.fullstack.achievements.2': 'Creato interfacce utente responsive e performanti con React e Tailwind CSS',
    'experience.items.fullstack.achievements.3': 'Integrato database relazionali con JPA/Hibernate e gestione avanzata dei dati',
  ...
  en: {
    ...
    'skills.items.microservices': 'Microservices',
    ...
    'experience.items.fullstack.title': 'Full Stack Developer',
    'experience.items.fullstack.company': 'Personal Projects & Portfolio',
    'experience.items.fullstack.location': 'Remote',
    'experience.items.fullstack.period': 'Present',
    'experience.items.fullstack.description': 'Development of modern web applications using the latest technologies, focusing on scalable architectures and optimal user experience.',
    'experience.items.fullstack.achievements.0': 'Developed 7+ complete full-stack projects with React, Next.js, Spring Boot and Flutter',
    'experience.items.fullstack.achievements.1': 'Implemented RESTful architectures and microservices with Java Spring Boot',
    'experience.items.fullstack.achievements.2': 'Created responsive and performant user interfaces with React and Tailwind CSS',
    'experience.items.fullstack.achievements.3': 'Integrated relational databases with JPA/Hibernate and advanced data management',
    'experience.items.ai.title': 'AI Integration Specialist',
    ...
    'footer.copyright': '© 2024 Vittorio Ciampi. All rights reserved.',
    // Toggles
